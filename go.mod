module gitee.com/prestonTao/keystore

go 1.18

// replace gitee.com/prestonTao/utils => ../utils

require (
	gitee.com/prestonTao/utils v0.0.0-20220801070456-5a007d7ea290
...
require (
	...
	github.com/prestonTao/utils v0.0.0-20220527083919-cd2f09fb8f62 // indirect
